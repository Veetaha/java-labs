...
class DAOImplNewsTest extends DAOImplTest {
    ...
    @Test
    void getNewsById() throws SQLException {
        ...
        assertEquals(newsService, newsService.getEntity(42));
        assertNull(newsService.getEntity(412));
    }

    @Test
    void getNewsList() throws SQLException {
        var newsService = new DAOImpl<>(News.class, mockConnection);
        ...
        var news = new News[] { mockNews, mockNews };
        var iter = Arrays.stream(news).iterator();
